        ...
        <div class="span12">
            ...
            <div class="span3">
                ...
                <br>
                    ...
                    <a href="add_student.php" class="btn btn-info"><i class="icon-plus-sign-alt"></i>&nbsp;Add Student</a>
                    <br><br>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td width="100">
                                            <a rel="tooltip"  title="Delete Course" id="d<?php echo $student_id; ?>" href="#course_id<?php echo $student_id; ?>" role="button"  data-toggle="modal" class="btn btn-info"><i class="icon-trash icon-large"></i></a>
                                            <a rel="tooltip"  title="Edit Course" id="e<?php echo $student_id; ?>" href="add_student.php?id=<?php echo $row['student_id'] ?>" class="btn btn-info"><i class="icon-pencil icon-large"></i></a>
                                        </td>
                                    ...
                                    <div id="course_id<?php echo $student_id; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="delete_student.php<?php echo '?id=' . $student_id; ?>" class="btn btn-info"><i class="icon-trash icon-large"></i>&nbsp;Delete</a>
                                        </div>
                                    </div>
