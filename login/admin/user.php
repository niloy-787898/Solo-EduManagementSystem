                                ...
                                <tbody>
                                    ...
                                    <script type="text/javascript">
                                        $(document).ready(function(){
                                            ...
                                            <td width="100">
                                                <a rel="tooltip"  title="Delete User" id="d<?php echo $user_id; ?>" href="#userdel<?php echo $user_id; ?>" role="button"  data-toggle="modal" class="btn btn-info"><i class="icon-trash icon-large"></i></a>
                                                <a rel="tooltip"  title="Edit User" id="e<?php echo $user_id; ?>" href="add_user.php?id=<?php echo $row['user_id'] ?>" class="btn btn-info"><i class="icon-pencil icon-large"></i></a>
                                            </td>
                                    ...
                                    <div id="userdel<?php echo $user_id; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                        ...
                                        <div class="modal-body">
                                            <div class="alert alert-info">Are you sure want to <strong>Delete</strong>&nbsp;this User?</div>
                                        </div>
                                        <div class="modal-footer">
                                            <button class="btn" data-dismiss="modal" aria-hidden="true"><i class="icon-remove icon-large"></i>&nbsp;Close</button>
                                            <a href="delete_user.php<?php echo '?id=' . $user_id; ?>" class="btn btn-info"><i class="icon-trash icon-large"></i>&nbsp;Delete</a>
                                        </div>
                                    </div>
